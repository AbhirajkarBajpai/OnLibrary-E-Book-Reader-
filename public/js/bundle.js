...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"bookPage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initialiase = initialiase;
...
function alertNotFound() {
  (0, _alerts.showAlert)('error', "Book Not Found");
}
function initialiase() {
  var viewer = new google.books.DefaultViewer(document.getElementById("viewerCanvas"));
  viewer.load("ISBN:" + isbn.value, alertNotFound);
}
},{"./alerts":"alerts.js"}],"favorites.js":[function(require,module,exports) {
"use strict";
...
var addToFavorites = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          bookId = event.target.getAttribute("data-book-id"); // Make an API call to add the book to favorites
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: "POST",
...
var button = document.querySelector("#read-book-btn");
